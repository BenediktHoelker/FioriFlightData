sap.ui.define([
		...
		return BaseObject.extend("fdmd.model.ListSelector", {
			 ...
			 * @return {fdmd.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
