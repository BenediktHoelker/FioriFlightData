/*global history */
sap.ui.define([
		"fdmd/controller/BaseController",
		...
		return BaseController.extend("fdmd.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("fldate", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("fdmd.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("SEATSMAX", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("SEATSMAX", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var context = {
							Carrid : mParams.firstListitem.getBindingContext().getProperty("carrid"),
							Connid : mParams.firstListitem.getBindingContext().getProperty("connid"),
							Fldate : mParams.firstListitem.getBindingContext().getProperty("fldate").toString()
						};
			...
			_showDetail : function (oItem) {
				...
				var context = {
							...
							Fldate : oItem.getBindingContext().getProperty("fldate").toString()               
						};
