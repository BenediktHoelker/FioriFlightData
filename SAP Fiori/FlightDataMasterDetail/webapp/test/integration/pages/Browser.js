					...
					iChangeTheHashToObjectN : function (iObjIndex) {
						return this.waitFor(this.createAWaitForAnEntitySet({
							...
							success : function (aEntitySet) {
								Opa5.getHashChanger().setHash("/FlightCollection/" + aEntitySet[iObjIndex].fldate);
							}
						}));
					},
					...
					iShouldSeeTheHashForObjectN : function (iObjIndex) {
						return this.waitFor(this.createAWaitForAnEntitySet({
							...
							success : function (aEntitySet) {
								...
								Opa5.assert.strictEqual(sHash, "FlightCollection/" + aEntitySet[iObjIndex].fldate, "The Hash is not correct");
							}
						}));
					},
